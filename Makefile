...
gen-include: bin/protoc-gen-go
	$(PROTOBUF_ROOT)/src/protoc \
		...
		-I$(PROTOBUF_ROOT)/src \
		github.com/19910211/vtprotobuf/vtproto/ext.proto
	mv include/github.com/19910211/vtprotobuf/vtproto/*.go ./vtproto
...
get-grpc-testproto: install
	$(PROTOBUF_ROOT)/src/protoc \
		...
		--go_opt=Mtestproto/grpc/inner/inner.proto=github.com/19910211/vtprotobuf/testproto/grpc/inner \
		--go-vtproto_opt=paths=source_relative \
        --go-vtproto_opt=Mtestproto/grpc/inner/inner.proto=github.com/19910211/vtprotobuf/testproto/grpc/inner \
